    ...
    <div class="box-body">
        <div class="form-group" style="padding">
            ...
            <div class="input-group mb-3">
                {!! Form::text('color', $materia->color, ['class' => 'form-control colorpicker', 'placeholder' => ' Selecciona un color']) !!}
                <span class="input-group-text" id="basic-addon1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#878787"
