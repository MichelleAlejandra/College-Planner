...
<div class="row">
    <div class="col" style="margin-left: 50px">
        <div class="tarjeta" style="background-color: rgba(128, 110, 80, 1);">
            ...
            <lord-icon src="https://cdn.lordicon.com/jcquurdy.json" trigger="hover" colors="primary:#FFFFFF" style="width:100%;height:100%">
            </lord-icon>
            <h1>{{$totalCreditos}}</h1>
    ...
    <div class="col">
        <div class="tarjeta" style="background-color: rgba(255, 90, 219, 1)">
            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
            <lord-icon src="https://cdn.lordicon.com/vgwctwpk.json" trigger="hover" colors="primary:#FFFFFF" state="hover" style="width:100%;height:100%">
            </lord-icon>
    ...
    <div class="col">
        <div class="tarjeta" style="background-color: rgba(251, 206, 61, 1)">
            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
            <lord-icon src="https://cdn.lordicon.com/nxvrkirq.json" trigger="hover" colors="primary:#FFFFFF" style="width:100%;height:100%">
            </lord-icon>
    ...
    <div class="col" >
        <div class="tarjeta" style="background-color: rgba(41, 192, 200, 1)">
            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
            <lord-icon src="https://cdn.lordicon.com/vereblpj.json" trigger="hover" colors="primary:#FFFFFF" style="width:100%;height:100%">
            </lord-icon>
    ...
    <div class="col" style="margin-right: 50px">
        ...
        <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
            <lord-icon src="https://cdn.lordicon.com/zjptfwtq.json" trigger="hover" colors="primary:#FFFFFF" style="width:100%;height:100%">
            </lord-icon>
